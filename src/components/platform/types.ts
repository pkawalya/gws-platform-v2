...
export type PageId = 'dashboard' | 'clients' | 'projects' | 'workflows' | 'spatial' | 'field-sync' | 'ai' | 'finance' | 'documents' | 'communications' | 'approvals' | 'audit' | 'organizations' | 'reports' | 'survey-reports' | 'settings' | 'role-permissions'
